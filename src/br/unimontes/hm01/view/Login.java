...
import br.wbessi.hm01.view.Main;
...
public class Login extends javax.swing.JFrame{
    ...
    private void loginBtnTxtMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_loginBtnTxtMouseClicked
        if(!userTxt.getText().equals("(Escreva o nome de usuário)") && 
            ...
            if(userTxt.getText().equals("Baleeiro") && String.valueOf(passTxt.getPassword()).equals("Chupai")) logar();
            //else javax.swing.JOptionPane.showMessageDialog(this, "Dados de Ingresso digitados:\nUsuário: " + userTxt.getText() + "\nSenha: "+ String.valueOf(passTxt.getPassword()), "LOGIN", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            else javax.swing.JOptionPane.showMessageDialog(this, "Usuário ou senha incorretos!!\nTente Novamente!", "LOGIN", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Login(main2).setVisible(true);
            }
        });
    }
